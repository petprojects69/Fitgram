...
import ru.petprojects69.fitgram.databinding.FragmentPhoneSigninBinding
import java.util.concurrent.TimeUnit

class PhoneSignInFragment: Fragment(R.layout.fragment_phone_signin) {
    private val binding: FragmentPhoneSigninBinding by viewBinding()
