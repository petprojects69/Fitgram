...
val militaryPress = ExerciseEntity(
    type = ExerciseType.POWER,
...
val tricepsExtension = ExerciseEntity(
    type = ExerciseType.POWER,
...
val barbellPull = ExerciseEntity(
    type = ExerciseType.POWER,
